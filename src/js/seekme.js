...
$(".medic div").each(function(){
		   ...
		   $(this).hover(function(){
		   	       $(this).parent().find("div").eq(0).find("div").stop().animate({"height":"0"},"fast").find("a,p").css("display","none");       
		   	      $(this).find("div").stop().animate({"height":"95"},"fast").find("a,p").css("display","block");
		   },function(){
		   	      $(this).find("div").stop().animate({"height":"0"},"fast").find("a,p").css("display","none");
		   	       $(this).parent().find("div").eq(0).find("div").stop().animate({"height":"95"},"fast").find("a,p").css("display","block");       
		   })
	})
})
