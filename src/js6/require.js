...
(function (ba) {
  ...
  function U(b, c, d, e) {
    c && A(c, function (c, i) {
      if (d || !t(b, i)) e && "object" === _typeof(c) && c && !H(c) && !G(c) && !(c instanceof RegExp) ? (b[i] || (b[i] = {}), U(b[i], c, d, e)) : b[i] = c;
    });
    return b;
  }
  ...
  if ("undefined" === typeof define) {
    ...
    e = requirejs = function requirejs(b, c, d, p) {
      var g,
          i = "_";
