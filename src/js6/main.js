...
$.get("ajax/ajax1.txt", function (data) {
  ...
  $.each(arr, function (i, value) {
    $("<li>\n\t\t      \t           <div class=\"li-l\">\n\t                             \t <h4>".concat(value.effect, "</h4>\n\t                             \t <h5>").concat(value.sample, "</h5>\n\t                             \t <p>\n\t\t                             \t <span>").concat(value.newmoney, "</span>\n\t\t                             \t <s>").concat(value.oldmoney, "</s>\n\t                             \t </p>\n\t                          </div>\n\t                            <a href=\"#\">\n\t                                <img src=\"").concat(value.img, "\"/> \n\t                            </a>\n                      </li>")).appendTo("main .rush .rush-t .rush-t-r .ru");
  });
});
$.get("ajax/ajax2.txt", function (data) {
  ...
  $.each(arr1, function (i, v) {
    $(" <li>\n                   \t   <img src=\"".concat(v.img, "\">\n                   \t   <p>").concat(v.show, "</p>\n                   \t   <div class=\"money\">\n                   \t   <span>").concat(v.newmoney, "</span>\n                   \t   <s>").concat(v.oldmoney, "</s>\n                   \t   </div>\n\t\t\t\t   </li>")).appendTo("main .caw .title .title-r .zxyp ul");
  });
});
$.get("ajax/ajax2.txt", function (data) {
  var object = JSON.parse(data);
...
$("#LoutiNav ul li").click(function () {
  ...
  $(this).find("span").addClass("active"); //点击左边导航 然后跳到指定的楼层
